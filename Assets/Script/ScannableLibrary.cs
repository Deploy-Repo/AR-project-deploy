...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    public class ScannableLibrary : MonoBehaviour
    {
        [Serializable]
        ...
        {
            [SerializeField, Tooltip("The Video that will Play.")]
        ...
        [SerializeField, Tooltip("The set of videos to add to the image library at runtime")]
        VideoData[] m_Videos;
        ...
        void Awake()
        {
            m_Images[0].name = m_Images[0].texture.name;
            m_Videos[0].name = m_Videos[0].videoClip.name;
            //m_Images[].videoClip = Resources.Load<VideoClip>("Scenes/ImageTracking/Videos");
        }
        enum State
        {
            NoImagesAdded,
